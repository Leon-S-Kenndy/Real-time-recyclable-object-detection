...
Java_com_hushiyu1995_yolo_1v3_Yolo_testyolo(JNIEnv *env, jobject obj, jstring imgfile) {
    ...
    char *datacfg_str = "/sdcard/yolo/data/obj.names";
    char *cfgfile_str = "/sdcard/yolo/cfg/yolov3-tiny-more.cfg";
    char *weightfile_str = "/sdcard/yolo/weights/yolov3-tiny-more_best.weights";
...
Java_com_hushiyu1995_yolo_1v3_Yolo_Rtestyolo(JNIEnv *env, jobject obj, jstring imgfile) {
double time;
const char *imgfile_str = (*env)->GetStringUTFChars(env, imgfile, 0);

char *datacfg_str = "/sdcard/yolo/data/Robj.names";
char *cfgfile_str = "/sdcard/yolo/cfg/yolov3-tiny-more.cfg";
char *weightfile_str = "/sdcard/yolo/weights/yolov3-tiny-more_best.weights";
char *outimgfile_str = "/sdcard/yolo/out";
time = test_detector(datacfg_str, cfgfile_str,
